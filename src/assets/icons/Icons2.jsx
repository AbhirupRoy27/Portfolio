import { SiExpress, SiNetlify, SiTailwindcss } from 'react-icons/si'

export function ScadCnUI() {
  return (
...
export function TailwindCss() {
  return (
    <button data-state="closed" data-slot="tooltip-trigger">
      <div className="size-6 hover:scale-120 transition-all duration-300 hover:cursor-pointer flex justify-center items-center">
        <SiTailwindcss size={60} color="rgb(51, 130, 246)" />
      </div>
    </button>
  )
}
...
export function Netlify() {
  return (
    <button data-state="closed" data-slot="tooltip-trigger">
      <div className="size-6 hover:scale-120 transition-all duration-300 hover:cursor-pointer flex justify-center items-center">
        <SiNetlify size={60} color="rgb(51, 130, 246)" />
      </div>
    </button>
  )
}
...
export function Express() {
  return (
    <button data-state="closed" data-slot="tooltip-trigger">
      <div className="size-6 hover:scale-115 transition-all duration-300 hover:cursor-pointer flex justify-center items-center">

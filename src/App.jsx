...
import Work from './components/Certificates'
      ...
      <nav className="navbar">
        <div className="navbar-content">
          ...
          <ul className={`nav-links${navOpen ? ' open' : ''}`}>
            ...
            <li><a href="#" onClick={(e) => handleNavLinkClick('progress', e)}>Certifications</a></li>
          ...
          <div className="nav-socials">
            ...
            <a href="mailto:rabhirup605@gmail.com" aria-label="Mail" className="nav-icon" target="_blank" rel="noopener noreferrer">
              <svg xmlns="https://www.svgrepo.com/show/502648/email.svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

...
import Work from './components/Certificate/Certificates'
              ...
              <div className="hero-content">
                <div className="hero-left">
                  ...
                  <p className="hero-intro">
                    Passionate front-end developer crafting beautiful,
                    responsive web experiences. I blend creative design with
                    clean code to build modern applications that users love.
                    Specialized in <b>React.js</b> and committed to delivering
                    pixel-perfect, performant solutions.
                  </p>
      ...
      <nav className="navbar">
        <div className="navbar-content">
          ...
          <ul className={`nav-links${navOpen ? ' open' : ''}`}>
            ...
            <li>
              <a href="#" onClick={(e) => handleNavLinkClick('Projects', e)}>
                Projects
              </a>
            </li>
            <li>
              <a href="#" onClick={(e) => handleNavLinkClick('progress', e)}>
                Certifications
              </a>
            </li>
            <li>
              <a href="#" onClick={(e) => handleNavLinkClick('skills', e)}>
                Skills
              </a>
            </li>
            <li>
              <a href="#" onClick={(e) => handleNavLinkClick('recent-work', e)}>
                Recent work
              </a>
            </li>
            <li>
              <a href="#" onClick={(e) => handleNavLinkClick('contact', e)}>
                Contact
              </a>
            </li>
          </ul>
